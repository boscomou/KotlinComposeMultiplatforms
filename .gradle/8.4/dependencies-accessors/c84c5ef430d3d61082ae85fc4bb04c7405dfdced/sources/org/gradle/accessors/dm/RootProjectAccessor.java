...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public KotlinComposeMultiplatformsProjectDependency getKotlinComposeMultiplatforms() { return new KotlinComposeMultiplatformsProjectDependency(getFactory(), create(":")); }
